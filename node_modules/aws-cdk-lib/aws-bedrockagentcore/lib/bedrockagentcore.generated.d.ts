...
export declare class CfnOnlineEvaluationConfig extends cdk.CfnResource implements cdk.IInspectable, IOnlineEvaluationConfigRef, cdk.ITaggableV2 {
     ...
     * The list of evaluators to apply during online evaluation.
     */
    get evaluators(): Array<CfnOnlineEvaluationConfig.EvaluatorReferenceProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The list of evaluators to apply during online evaluation.
     */
    set evaluators(value: Array<CfnOnlineEvaluationConfig.EvaluatorReferenceProperty | cdk.IResolvable> | cdk.IResolvable);
